...
app.jwt.issuer=secure-admin-api
```
...
```text
src/main/java/com/example/secureadmin/config/JwtProperties.java
```
...
```text
src/main/java/com/example/secureadmin/config/SecurityConfig.java
```
...
```text
src/main/java/com/example/secureadmin/service/JwtService.java
```
