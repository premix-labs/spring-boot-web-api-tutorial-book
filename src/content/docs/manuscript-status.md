...
- มีโปรเจกต์รวมท้ายเล่มใน `examples/final-backend-api/`
- โปรเจกต์รวมท้ายเล่มรัน `test` และ `bootJar` ผ่านแล้วด้วย JDK 25
- มีหน้าอธิบาย final project ใน `appendix/final-project`
- มี Postman collection และ environment สำหรับ final project ใน `examples/final-backend-api/postman/`
...
1. ตรวจเทียบ code snippet รายบทกับ `final-backend-api` อีกรอบ เพื่อให้ชื่อ class/package ตรงกันมากที่สุด
